...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/60 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=open]:duration-500 data-[state=closed]:duration-400 ease-[cubic-bezier(0.22,1,0.36,1)]",
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/40 backdrop-blur-2xl backdrop-saturate-150 border-border/40 p-6 shadow-2xl will-change-transform data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:duration-500 data-[state=closed]:duration-400 ease-[cubic-bezier(0.22,1,0.36,1)]",
  {
    variants: {
      side: {
